...
public class HexagonalTiledMapRenderer extends BatchTiledMapRenderer {
    ...
    public void renderTileLayer(TiledMapTileLayer layer) {
        ...
        int col1 = Math.max(0, (int) ((this.viewBounds.f98x - (layerTileWidth * 0.25f)) / layerTileWidth75));
        int col2 = Math.min(layerWidth, (int) (((this.viewBounds.f98x + this.viewBounds.width) + layerTileWidth75) / layerTileWidth75));
        int row1 = Math.max(0, (int) (this.viewBounds.f99y / layerTileHeight150));
        int row2 = Math.min(layerHeight, (int) (((this.viewBounds.f99y + this.viewBounds.height) + layerTileHeight150) / layerTileHeight));
