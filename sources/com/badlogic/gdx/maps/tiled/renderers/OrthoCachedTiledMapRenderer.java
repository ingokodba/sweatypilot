...
public class OrthoCachedTiledMapRenderer implements TiledMapRenderer, Disposable {
    ...
    public void setView(OrthographicCamera camera) {
        ...
        this.viewBounds.set(camera.position.f107x - (width / 2.0f), camera.position.f108y - (height / 2.0f), width, height);
        if ((this.canCacheMoreW && this.viewBounds.f98x < this.cacheBounds.f98x - tolerance) || ((this.canCacheMoreS && this.viewBounds.f99y < this.cacheBounds.f99y - tolerance) || ((this.canCacheMoreE && this.viewBounds.f98x + this.viewBounds.width > (this.cacheBounds.f98x + this.cacheBounds.width) + tolerance) || (this.canCacheMoreN && this.viewBounds.f99y + this.viewBounds.height > (this.cacheBounds.f99y + this.cacheBounds.height) + tolerance)))) {
            this.cached = false;
        }
    }
    ...
    public void render() {
        ...
        if (!this.cached) {
            ...
            this.cacheBounds.f98x = this.viewBounds.f98x - extraWidth;
            this.cacheBounds.f99y = this.viewBounds.f99y - extraHeight;
    ...
    public void renderTileLayer(TiledMapTileLayer layer) {
        ...
        int col1 = Math.max(0, (int) (this.cacheBounds.f98x / layerTileWidth));
        int col2 = Math.min(layerWidth, (int) (((this.cacheBounds.f98x + this.cacheBounds.width) + layerTileWidth) / layerTileWidth));
        int row1 = Math.max(0, (int) (this.cacheBounds.f99y / layerTileHeight));
        int row2 = Math.min(layerHeight, (int) (((this.cacheBounds.f99y + this.cacheBounds.height) + layerTileHeight) / layerTileHeight));
    ...
    public void renderImageLayer(TiledMapImageLayer layer) {
        ...
        if (region != null) {
            float x1 = ((float) layer.getX()) * this.unitScale;
            float y1 = ((float) layer.getY()) * this.unitScale;
            float x2 = x1 + (((float) region.getRegionWidth()) * this.unitScale);
            float y2 = y1 + (((float) region.getRegionHeight()) * this.unitScale);
