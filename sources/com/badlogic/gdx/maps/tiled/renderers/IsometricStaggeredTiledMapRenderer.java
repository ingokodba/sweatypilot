...
public class IsometricStaggeredTiledMapRenderer extends BatchTiledMapRenderer {
    ...
    public void renderTileLayer(TiledMapTileLayer layer) {
        ...
        int minX = Math.max(0, (int) ((this.viewBounds.f98x - layerTileWidth50) / layerTileWidth));
        int maxX = Math.min(layerWidth, (int) ((((this.viewBounds.f98x + this.viewBounds.width) + layerTileWidth) + layerTileWidth50) / layerTileWidth));
        int minY = Math.max(0, (int) ((this.viewBounds.f99y - layerTileHeight) / layerTileHeight));
        for (int y = Math.min(layerHeight, (int) (((this.viewBounds.f99y + this.viewBounds.height) + layerTileHeight) / layerTileHeight50)) - 1; y >= minY; y--) {
