...
public class OrthogonalTiledMapRenderer extends BatchTiledMapRenderer {
    ...
    public void renderTileLayer(TiledMapTileLayer layer) {
        ...
        int col1 = Math.max(0, (int) (this.viewBounds.f98x / layerTileWidth));
        int col2 = Math.min(layerWidth, (int) (((this.viewBounds.f98x + this.viewBounds.width) + layerTileWidth) / layerTileWidth));
        int row1 = Math.max(0, (int) (this.viewBounds.f99y / layerTileHeight));
        int row2 = Math.min(layerHeight, (int) (((this.viewBounds.f99y + this.viewBounds.height) + layerTileHeight) / layerTileHeight));
