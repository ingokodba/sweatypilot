...
public abstract class Viewport {
    ...
    public Vector2 toScreenCoordinates(Vector2 worldCoords, Matrix4 transformMatrix) {
        this.tmp.set(worldCoords.f102x, worldCoords.f103y, 0.0f);
        this.tmp.mul(transformMatrix);
        this.camera.project(this.tmp);
        this.tmp.f108y = ((float) Gdx.graphics.getHeight()) - this.tmp.f108y;
        worldCoords.f102x = this.tmp.f107x;
        worldCoords.f103y = this.tmp.f108y;
        return worldCoords;
    }
