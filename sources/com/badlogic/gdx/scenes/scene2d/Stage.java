...
public class Stage extends InputAdapter implements Disposable {
    ...
    private void drawDebug() {
        ...
        if (this.debugUnderMouse || this.debugParentUnderMouse || this.debugTableUnderMouse != Debug.none) {
            ...
            Actor actor = hit(this.tempCoords.f102x, this.tempCoords.f103y, true);
            if (actor != null) {
    ...
    public void act(float delta) {
        ...
        for (int pointer = 0; pointer < n; pointer++) {
            ...
            if (this.pointerTouched[pointer]) {
                ...
                event.setStage(this);
                event.setStageX(this.tempCoords.f102x);
                event.setStageY(this.tempCoords.f103y);
    ...
    private Actor fireEnterAndExit(Actor overLast, int screenX, int screenY, int pointer) {
        ...
        Actor over = hit(this.tempCoords.f102x, this.tempCoords.f103y, true);
        if (over == overLast) {
            return overLast;
        }
        InputEvent event = (InputEvent) Pools.obtain(InputEvent.class);
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        Actor target = hit(this.tempCoords.f102x, this.tempCoords.f103y, true);
        if (target != null) {
            target.fire(event);
    ...
    public Actor hit(float stageX, float stageY, boolean touchable) {
        ...
        return this.root.hit(this.tempCoords.f102x, this.tempCoords.f103y, touchable);
    }
    ...
    public Vector2 stageToScreenCoordinates(Vector2 stageCoords) {
        ...
        stageCoords.f103y = ((float) this.viewport.getScreenHeight()) - stageCoords.f103y;
        return stageCoords;
    }
