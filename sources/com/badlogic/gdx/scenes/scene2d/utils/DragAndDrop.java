                    ...
                    if (hit != null) {
                        ...
                        for (int i = 0; i < n; i++) {
                            ...
                            if (target.actor.isAscendantOf(hit)) {
                                ...
                                DragAndDrop.this.isValidTarget = target.drag(source, DragAndDrop.this.payload, DragAndDrop.tmpVector.f102x, DragAndDrop.tmpVector.f103y, pointer);
                                break;
                            }
                        }
                    }
                ...
                if (pointer == DragAndDrop.this.activePointer) {
                    ...
                    if (DragAndDrop.this.payload != null) {
                        ...
                        if (DragAndDrop.this.isValidTarget) {
                            ...
                            DragAndDrop.this.target.drop(source, DragAndDrop.this.payload, DragAndDrop.tmpVector.f102x, DragAndDrop.tmpVector.f103y, pointer);
                        }
