...
public class Actor {
    ...
    public Vector2 localToParentCoordinates(Vector2 localCoords) {
        ...
        if (rotation != 0.0f) {
            ...
            float tox = (localCoords.f102x - originX) * scaleX;
            float toy = (localCoords.f103y - originY) * scaleY;
            localCoords.f102x = (((tox * cos) + (toy * sin)) + originX) + x;
            localCoords.f103y = ((((-sin) * tox) + (toy * cos)) + originY) + y;
            ...
            originX = this.originX;
            originY = this.originY;
            localCoords.f102x = (((localCoords.f102x - originX) * scaleX) + originX) + x;
            localCoords.f103y = (((localCoords.f103y - originY) * scaleY) + originY) + y;
        }
        return localCoords;
    }
    ...
    public Vector2 parentToLocalCoordinates(Vector2 parentCoords) {
        ...
        if (rotation != 0.0f) {
            ...
            originX = this.originX;
            originY = this.originY;
            float tox = (parentCoords.f102x - childX) - originX;
            float toy = (parentCoords.f103y - childY) - originY;
            parentCoords.f102x = (((tox * cos) + (toy * sin)) / scaleX) + originX;
            parentCoords.f103y = ((((-sin) * tox) + (toy * cos)) / scaleY) + originY;
        } else if (scaleX == 1.0f && scaleY == 1.0f) {
            parentCoords.f102x -= childX;
            parentCoords.f103y -= childY;
        } else {
            originX = this.originX;
            originY = this.originY;
            parentCoords.f102x = (((parentCoords.f102x - childX) - originX) / scaleX) + originX;
            parentCoords.f103y = (((parentCoords.f103y - childY) - originY) / scaleY) + originY;
        }
        return parentCoords;
    }
    ...
    protected void drawDebugBounds(ShapeRenderer shapes) {
        if (this.debug) {
            ...
            shapes.rect(this.f73x, this.f74y, this.originX, this.originY, this.width, this.height, this.scaleX, this.scaleY, this.rotation);
        }
    }
