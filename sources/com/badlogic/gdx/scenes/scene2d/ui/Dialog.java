...
public class Dialog extends Window {
    ...
    protected InputListener ignoreTouchDown = new C01041();
    ...
    class C01041 extends InputListener {
        C01041() {
        }
    ...
    class C01052 extends ChangeListener {
        C01052() {
        }
    ...
    class C01063 extends FocusListener {
        C01063() {
        }
    ...
    private void initialize() {
        ...
        this.buttonTable.addListener(new C01052());
        this.focusListener = new C01063();
    }
