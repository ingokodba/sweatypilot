...
public class List<T> extends Widget implements Cullable {
    ...
    class C01081 extends InputListener {
        C01081() {
        }
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        font.setColor(fontColorUnselected.f39r, fontColorUnselected.f38g, fontColorUnselected.f37b, fontColorUnselected.f36a * parentAlpha);
        for (int i = 0; i < this.items.size; i++) {
            if (this.cullingArea == null || (itemY - this.itemHeight <= this.cullingArea.f99y + this.cullingArea.height && itemY >= this.cullingArea.f99y)) {
                ...
                if (selected) {
                    ...
                    font.setColor(fontColorSelected.f39r, fontColorSelected.f38g, fontColorSelected.f37b, fontColorSelected.f36a * parentAlpha);
                }
                font.draw(batch, item.toString(), this.textOffsetX + x, (y + itemY) - this.textOffsetY);
                if (selected) {
                    font.setColor(fontColorUnselected.f39r, fontColorUnselected.f38g, fontColorUnselected.f37b, fontColorUnselected.f36a * parentAlpha);
                }
            } else if (itemY < this.cullingArea.f99y) {
                return;
            }
