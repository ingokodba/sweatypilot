    ...
    public class TextFieldClickListener extends ClickListener {
        ...
        public boolean keyTyped(InputEvent event, char character) {
            ...
            if ((character == TextField.TAB || character == TextField.ENTER_ANDROID) && TextField.this.focusTraversal) {
                ...
                boolean add = !TextField.this.onlyFontChars || TextField.this.style.font.getData().hasGlyph(character) || (TextField.this.writeEnters && (character == TextField.ENTER_ANDROID || character == TextField.ENTER_DESKTOP));
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        if (this.displayText.length() != 0) {
            ...
            if (this.style.messageFontColor != null) {
                font.setColor(this.style.messageFontColor.f39r, this.style.messageFontColor.f38g, this.style.messageFontColor.f37b, this.style.messageFontColor.f36a * parentAlpha);
            } else {
            ...
            if (actor != this) {
                if (actor instanceof TextField) {
                    ...
                    if (!textField.isDisabled() && textField.focusTraversal) {
                        ...
                        int i2 = (actorCoords.f103y < currentCoords.f103y || (actorCoords.f103y == currentCoords.f103y && actorCoords.f102x > currentCoords.f102x)) ? 1 : 0;
                        if ((i2 ^ up) != 0) {
                            if (best != null) {
                                i2 = (actorCoords.f103y > bestCoords.f103y || (actorCoords.f103y == bestCoords.f103y && actorCoords.f102x < bestCoords.f102x)) ? 1 : 0;
                                if ((i2 ^ up) == 0) {
                                }
                            }
