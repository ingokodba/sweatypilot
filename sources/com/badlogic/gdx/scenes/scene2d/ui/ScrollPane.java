...
public class ScrollPane extends WidgetGroup {
    ...
    class C01091 extends InputListener {
        ...
        public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
            ...
            if (ScrollPane.this.scrollX && ScrollPane.this.hScrollBounds.contains(x, y)) {
                ...
                if (ScrollPane.this.hKnobBounds.contains(x, y)) {
                    ...
                    this.handlePosition = ScrollPane.this.hKnobBounds.f98x;
                ...
                if (x >= ScrollPane.this.hKnobBounds.f98x) {
                    i = 1;
                }
                ...
                if (ScrollPane.this.vKnobBounds.contains(x, y)) {
                    ScrollPane.this.lastPoint.set(x, y);
                    this.handlePosition = ScrollPane.this.vKnobBounds.f99y;
                ...
                if (y < ScrollPane.this.vKnobBounds.f99y) {
                    i = 1;
                }
        ...
        public void touchDragged(InputEvent event, float x, float y, int pointer) {
            if (pointer == ScrollPane.this.draggingPointer) {
                ...
                if (ScrollPane.this.touchScrollH) {
                    float scrollH = this.handlePosition + (x - ScrollPane.this.lastPoint.f102x);
                    this.handlePosition = scrollH;
                    scrollH = Math.min((ScrollPane.this.hScrollBounds.f98x + ScrollPane.this.hScrollBounds.width) - ScrollPane.this.hKnobBounds.width, Math.max(ScrollPane.this.hScrollBounds.f98x, scrollH));
                    total = ScrollPane.this.hScrollBounds.width - ScrollPane.this.hKnobBounds.width;
                    if (total != 0.0f) {
                        ScrollPane.this.setScrollPercentX((scrollH - ScrollPane.this.hScrollBounds.f98x) / total);
                    }
                    ScrollPane.this.lastPoint.set(x, y);
                } else if (ScrollPane.this.touchScrollV) {
                    float scrollV = this.handlePosition + (y - ScrollPane.this.lastPoint.f103y);
                    this.handlePosition = scrollV;
                    scrollV = Math.min((ScrollPane.this.vScrollBounds.f99y + ScrollPane.this.vScrollBounds.height) - ScrollPane.this.vKnobBounds.height, Math.max(ScrollPane.this.vScrollBounds.f99y, scrollV));
                    total = ScrollPane.this.vScrollBounds.height - ScrollPane.this.vKnobBounds.height;
                    if (total != 0.0f) {
                        ScrollPane.this.setScrollPercentY(1.0f - ((scrollV - ScrollPane.this.vScrollBounds.f99y) / total));
                    }
                    ScrollPane.this.lastPoint.set(x, y);
                }
            }
    ...
    class C01102 extends ActorGestureListener {
        C01102() {
        }
    ...
    class C01113 extends InputListener {
        C01113() {
        }
    ...
    public ScrollPane(Actor widget, ScrollPaneStyle style) {
        ...
        addCaptureListener(new C01091());
        this.flickScrollListener = new C01102();
        addListener(this.flickScrollListener);
        addListener(new C01113());
    }
        ...
        if (this.widget != null) {
            ...
            if (fade) {
                ...
                if (this.scrollX && this.hScrollOnBottom) {
                    r22 = this.widgetAreaBounds;
                    r22.f99y += scrollbarHeight;
                }
                if (this.scrollY && !this.vScrollOnRight) {
                    r22 = this.widgetAreaBounds;
                    r22.f98x += scrollbarWidth;
                }
            }
            ...
            if (this.scrollX) {
                if (hScrollKnob != null) {
                    ...
                    this.hKnobBounds.f98x = this.hScrollBounds.f98x + ((float) ((int) ((this.hScrollBounds.width - this.hKnobBounds.width) * getScrollPercentX())));
                    this.hKnobBounds.f99y = this.hScrollBounds.f99y;
                } else {
            ...
            if (this.scrollY) {
                if (vScrollKnob != null) {
                    ...
                    if (this.vScrollOnRight) {
                        this.vKnobBounds.f98x = (width - bgRightWidth) - vScrollKnob.getMinWidth();
                    } else {
                        this.vKnobBounds.f98x = bgLeftWidth;
                    }
                    this.vKnobBounds.f99y = this.vScrollBounds.f99y + ((float) ((int) ((this.vScrollBounds.height - this.vKnobBounds.height) * (1.0f - getScrollPercentY()))));
                } else {
    ...
    public void draw(Batch batch, float parentAlpha) {
        if (this.widget != null) {
            ...
            if (this.scrollX) {
                this.hKnobBounds.f98x = this.hScrollBounds.f98x + ((float) ((int) ((this.hScrollBounds.width - this.hKnobBounds.width) * getVisualScrollPercentX())));
            }
            if (this.scrollY) {
                this.vKnobBounds.f99y = this.vScrollBounds.f99y + ((float) ((int) ((this.vScrollBounds.height - this.vKnobBounds.height) * (1.0f - getVisualScrollPercentY()))));
            }
            float y = this.widgetAreaBounds.f99y;
            if (this.scrollY) {
                y -= (float) ((int) (this.maxY - this.visualAmountY));
            } else {
                y -= (float) ((int) this.maxY);
            }
            float x = this.widgetAreaBounds.f98x;
            if (this.scrollX) {
            ...
            if (this.widget instanceof Cullable) {
                this.widgetCullingArea.f98x = (-this.widget.getX()) + this.widgetAreaBounds.f98x;
                this.widgetCullingArea.f99y = (-this.widget.getY()) + this.widgetAreaBounds.f99y;
            ...
            batch.setColor(color.f39r, color.f38g, color.f37b, (color.f36a * parentAlpha) * Interpolation.fade.apply(this.fadeAlpha / this.fadeAlphaSeconds));
            if (this.scrollX && this.scrollY && this.style.corner != null) {
                this.style.corner.draw(batch, this.hScrollBounds.width + this.hScrollBounds.f98x, this.hScrollBounds.f99y, this.vScrollBounds.width, this.vScrollBounds.f99y);
            }
            if (this.scrollX) {
                if (this.style.hScroll != null) {
                    this.style.hScroll.draw(batch, this.hScrollBounds.f98x, this.hScrollBounds.f99y, this.hScrollBounds.width, this.hScrollBounds.height);
                }
                if (this.style.hScrollKnob != null) {
                    this.style.hScrollKnob.draw(batch, this.hKnobBounds.f98x, this.hKnobBounds.f99y, this.hKnobBounds.width, this.hKnobBounds.height);
                }
            }
            if (this.scrollY) {
                if (this.style.vScroll != null) {
                    this.style.vScroll.draw(batch, this.vScrollBounds.f98x, this.vScrollBounds.f99y, this.vScrollBounds.width, this.vScrollBounds.height);
                }
                if (this.style.vScrollKnob != null) {
                    this.style.vScrollKnob.draw(batch, this.vKnobBounds.f98x, this.vKnobBounds.f99y, this.vKnobBounds.width, this.vKnobBounds.height);
                }
            }
