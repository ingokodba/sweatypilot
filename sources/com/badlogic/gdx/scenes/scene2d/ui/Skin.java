...
public class Skin implements Disposable {
    ...
    class C01164 extends ReadOnlySerializer<Color> {
        C01164() {
        }
    ...
    class C01175 extends ReadOnlySerializer {
        C01175() {
        }
    ...
    protected Json getJsonLoader(final FileHandle skinFile) {
        ...
        json.setSerializer(Color.class, new C01164());
        json.setSerializer(TintedDrawable.class, new C01175());
        return json;
    }
