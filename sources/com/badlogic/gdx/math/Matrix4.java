...
public class Matrix4 implements Serializable {
    ...
    public Matrix4 set(Vector3 position, Quaternion orientation) {
        return set(position.f107x, position.f108y, position.f109z, orientation.f67x, orientation.f68y, orientation.f69z, orientation.f66w);
    }
    ...
    public Matrix4 set(Vector3 position, Quaternion orientation, Vector3 scale) {
        return set(position.f107x, position.f108y, position.f109z, orientation.f67x, orientation.f68y, orientation.f69z, orientation.f66w, scale.f107x, scale.f108y, scale.f109z);
    }
    ...
    public Matrix4 set(Vector3 xAxis, Vector3 yAxis, Vector3 zAxis, Vector3 pos) {
        this.val[0] = xAxis.f107x;
        this.val[4] = xAxis.f108y;
        this.val[8] = xAxis.f109z;
        this.val[1] = yAxis.f107x;
        this.val[5] = yAxis.f108y;
        this.val[9] = yAxis.f109z;
        this.val[2] = zAxis.f107x;
        this.val[6] = zAxis.f108y;
        this.val[10] = zAxis.f109z;
        this.val[12] = pos.f107x;
        this.val[13] = pos.f108y;
        this.val[14] = pos.f109z;
        this.val[3] = 0.0f;
        this.val[7] = 0.0f;
        this.val[11] = 0.0f;
        this.val[15] = 1.0f;
    ...
    public Matrix4 trn(Vector3 vector) {
        float[] fArr = this.val;
        fArr[12] = fArr[12] + vector.f107x;
        fArr = this.val;
        fArr[13] = fArr[13] + vector.f108y;
        fArr = this.val;
        fArr[14] = fArr[14] + vector.f109z;
        return this;
    }
    ...
    public Matrix4 setToProjection(float left, float right, float bottom, float top, float near, float far) {
        ...
        float l_a1 = (far + near) / (near - far);
        float l_a2 = ((2.0f * far) * near) / (near - far);
        this.val[0] = (2.0f * near) / (right - left);
        this.val[1] = 0.0f;
        this.val[2] = 0.0f;
        this.val[3] = 0.0f;
        this.val[4] = 0.0f;
    ...
    public Matrix4 setTranslation(Vector3 vector) {
        this.val[12] = vector.f107x;
        this.val[13] = vector.f108y;
        this.val[14] = vector.f109z;
        return this;
    }
    ...
    public Matrix4 setToTranslationAndScaling(Vector3 translation, Vector3 scaling) {
        idt();
        this.val[12] = translation.f107x;
        this.val[13] = translation.f108y;
        this.val[14] = translation.f109z;
        this.val[0] = scaling.f107x;
        this.val[5] = scaling.f108y;
        this.val[10] = scaling.f109z;
        return this;
    }
    ...
    public Matrix4 setToScaling(Vector3 vector) {
        idt();
        this.val[0] = vector.f107x;
        this.val[5] = vector.f108y;
        this.val[10] = vector.f109z;
        return this;
    }
    ...
    public Matrix4 setToLookAt(Vector3 direction, Vector3 up) {
        ...
        idt();
        this.val[0] = l_vex.f107x;
        this.val[4] = l_vex.f108y;
        this.val[8] = l_vex.f109z;
        this.val[1] = l_vey.f107x;
        this.val[5] = l_vey.f108y;
        this.val[9] = l_vey.f109z;
        this.val[2] = -l_vez.f107x;
        this.val[6] = -l_vez.f108y;
        this.val[10] = -l_vez.f109z;
        return this;
    }
    ...
    public Matrix4 setToLookAt(Vector3 position, Vector3 target, Vector3 up) {
        ...
        mul(tmpMat.setToTranslation(-position.f107x, -position.f108y, -position.f109z));
        return this;
    }
    ...
    public Matrix4 scl(Vector3 scale) {
        float[] fArr = this.val;
        fArr[0] = fArr[0] * scale.f107x;
        fArr = this.val;
        fArr[5] = fArr[5] * scale.f108y;
        fArr = this.val;
        fArr[10] = fArr[10] * scale.f109z;
        return this;
    }
    ...
    public Vector3 getTranslation(Vector3 position) {
        position.f107x = this.val[12];
        position.f108y = this.val[13];
        position.f109z = this.val[14];
        return position;
    }
    ...
    public Matrix4 translate(Vector3 translation) {
        return translate(translation.f107x, translation.f108y, translation.f109z);
    }
