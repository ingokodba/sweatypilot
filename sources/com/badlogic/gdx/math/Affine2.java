...
public final class Affine2 implements Serializable {
    ...
    public Affine2 setToTranslation(Vector2 trn) {
        return setToTranslation(trn.f102x, trn.f103y);
    }
    ...
    public Affine2 setToScaling(Vector2 scale) {
        return setToScaling(scale.f102x, scale.f103y);
    }
    ...
    public Affine2 setToShearing(Vector2 shear) {
        return setToShearing(shear.f102x, shear.f103y);
    }
    ...
    public Affine2 setToTrnRotScl(Vector2 trn, float degrees, Vector2 scale) {
        return setToTrnRotScl(trn.f102x, trn.f103y, degrees, scale.f102x, scale.f103y);
    }
    ...
    public Affine2 setToTrnRotRadScl(Vector2 trn, float radians, Vector2 scale) {
        return setToTrnRotRadScl(trn.f102x, trn.f103y, radians, scale.f102x, scale.f103y);
    }
    ...
    public Affine2 setToTrnScl(Vector2 trn, Vector2 scale) {
        return setToTrnScl(trn.f102x, trn.f103y, scale.f102x, scale.f103y);
    }
    ...
    public Affine2 translate(Vector2 trn) {
        return translate(trn.f102x, trn.f103y);
    }
    ...
    public Affine2 preTranslate(Vector2 trn) {
        return preTranslate(trn.f102x, trn.f103y);
    }
    ...
    public Affine2 scale(Vector2 scale) {
        return scale(scale.f102x, scale.f103y);
    }
    ...
    public Affine2 preScale(Vector2 scale) {
        return preScale(scale.f102x, scale.f103y);
    }
    ...
    public Affine2 shear(Vector2 shear) {
        return shear(shear.f102x, shear.f103y);
    }
    ...
    public Affine2 preShear(Vector2 shear) {
        return preShear(shear.f102x, shear.f103y);
    }
    ...
    public Vector2 getTranslation(Vector2 position) {
        position.f102x = this.m02;
        position.f103y = this.m12;
        return position;
    }
    ...
    public void applyTo(Vector2 point) {
        float x = point.f102x;
        float y = point.f103y;
        point.f102x = ((this.m00 * x) + (this.m01 * y)) + this.m02;
        point.f103y = ((this.m10 * x) + (this.m11 * y)) + this.m12;
    }
