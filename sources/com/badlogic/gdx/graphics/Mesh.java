...
public class Mesh implements Disposable {
    ...
    public float calculateRadius(Vector3 center, int offset, int count, Matrix4 transform) {
        return calculateRadius(center.f107x, center.f108y, center.f109z, offset, count, transform);
    }
    ...
    public float calculateRadius(Vector3 center, int offset, int count) {
        return calculateRadius(center.f107x, center.f108y, center.f109z, offset, count, null);
    }
    ...
    public float calculateRadius(Vector3 center) {
        return calculateRadius(center.f107x, center.f108y, center.f109z, 0, getNumIndices(), null);
    }
    ...
    public static void transformUV(Matrix3 matrix, float[] vertices, int vertexSize, int offset, int start, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            vertices[idx] = tmp.f102x;
            vertices[idx + 1] = tmp.f103y;
            idx += vertexSize;
        }
    }
