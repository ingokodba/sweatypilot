...
public class AmbientCubemap {
    ...
    public AmbientCubemap set(Color color) {
        return set(color.f39r, color.f38g, color.f37b);
    }
    ...
    public AmbientCubemap add(Color color) {
        return add(color.f39r, color.f38g, color.f37b);
    }
    ...
    public AmbientCubemap add(Color color, Vector3 direction) {
        return add(color.f39r, color.f38g, color.f37b, direction.f107x, direction.f108y, direction.f109z);
    }

    public AmbientCubemap add(float r, float g, float b, Vector3 direction) {
        return add(r, g, b, direction.f107x, direction.f108y, direction.f109z);
    }

    public AmbientCubemap add(Color color, float x, float y, float z) {
        return add(color.f39r, color.f38g, color.f37b, x, y, z);
    }

    public AmbientCubemap add(Color color, Vector3 point, Vector3 target) {
        return add(color.f39r, color.f38g, color.f37b, target.f107x - point.f107x, target.f108y - point.f108y, target.f109z - point.f109z);
    }
    ...
    public AmbientCubemap add(Color color, Vector3 point, Vector3 target, float intensity) {
        ...
        return add(color.f39r * t, color.f38g * t, color.f37b * t, target.f107x - point.f107x, target.f108y - point.f108y, target.f109z - point.f109z);
    }
