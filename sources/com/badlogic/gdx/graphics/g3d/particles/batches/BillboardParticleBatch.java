...
public class BillboardParticleBatch extends BufferedParticleBatch<BillboardControllerRenderData> {
    ...
    private static void putVertex(float[] vertices, int offset, Vector3 p, float u, float v, float r, float g, float b, float a) {
        vertices[CPU_POSITION_OFFSET + offset] = p.f107x;
        vertices[(CPU_POSITION_OFFSET + offset) + 1] = p.f108y;
        vertices[(CPU_POSITION_OFFSET + offset) + 2] = p.f109z;
        ...
        while (i$.hasNext()) {
            ...
            while (p < c) {
                ...
                if (cosRotation != 1.0f) {
                    ...
                    putVertex(this.vertices, baseOffset, TMP_V6.set((-TMP_V1.f107x) - TMP_V2.f107x, (-TMP_V1.f108y) - TMP_V2.f108y, (-TMP_V1.f109z) - TMP_V2.f109z).mul(TMP_M3).add(px, py, pz), u, v2, r, g, b, a);
                    baseOffset += this.currentVertexSize;
                    putVertex(this.vertices, baseOffset, TMP_V6.set(TMP_V1.f107x - TMP_V2.f107x, TMP_V1.f108y - TMP_V2.f108y, TMP_V1.f109z - TMP_V2.f109z).mul(TMP_M3).add(px, py, pz), u2, v2, r, g, b, a);
                    baseOffset += this.currentVertexSize;
                    putVertex(this.vertices, baseOffset, TMP_V6.set(TMP_V1.f107x + TMP_V2.f107x, TMP_V1.f108y + TMP_V2.f108y, TMP_V1.f109z + TMP_V2.f109z).mul(TMP_M3).add(px, py, pz), u2, v, r, g, b, a);
                    putVertex(this.vertices, baseOffset + this.currentVertexSize, TMP_V6.set((-TMP_V1.f107x) + TMP_V2.f107x, (-TMP_V1.f108y) + TMP_V2.f108y, (-TMP_V1.f109z) + TMP_V2.f109z).mul(TMP_M3).add(px, py, pz), u, v, r, g, b, a);
                } else {
                    putVertex(this.vertices, baseOffset, TMP_V6.set(((-TMP_V1.f107x) - TMP_V2.f107x) + px, ((-TMP_V1.f108y) - TMP_V2.f108y) + py, ((-TMP_V1.f109z) - TMP_V2.f109z) + pz), u, v2, r, g, b, a);
                    baseOffset += this.currentVertexSize;
                    putVertex(this.vertices, baseOffset, TMP_V6.set((TMP_V1.f107x - TMP_V2.f107x) + px, (TMP_V1.f108y - TMP_V2.f108y) + py, (TMP_V1.f109z - TMP_V2.f109z) + pz), u2, v2, r, g, b, a);
                    baseOffset += this.currentVertexSize;
                    putVertex(this.vertices, baseOffset, TMP_V6.set((TMP_V1.f107x + TMP_V2.f107x) + px, (TMP_V1.f108y + TMP_V2.f108y) + py, (TMP_V1.f109z + TMP_V2.f109z) + pz), u2, v, r, g, b, a);
                    putVertex(this.vertices, baseOffset + this.currentVertexSize, TMP_V6.set(((-TMP_V1.f107x) + TMP_V2.f107x) + px, ((-TMP_V1.f108y) + TMP_V2.f108y) + py, ((-TMP_V1.f109z) + TMP_V2.f109z) + pz), u, v, r, g, b, a);
                }
                p++;
                tp++;
            }
