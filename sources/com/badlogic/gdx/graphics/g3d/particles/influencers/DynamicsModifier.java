    ...
    public static class FaceDirection extends DynamicsModifier {
        ...
        public void update() {
            ...
            while (i < c) {
                ...
                Vector3 axisY = TMP_V2.set(TMP_V1).crs(Vector3.f105Y).nor().crs(TMP_V1).nor();
                Vector3 axisX = TMP_V3.set(axisY).crs(axisZ).nor();
                TMP_Q.setFromAxes(false, axisX.f107x, axisY.f107x, axisZ.f107x, axisX.f108y, axisY.f108y, axisZ.f108y, axisX.f109z, axisY.f109z, axisZ.f109z);
                this.rotationChannel.data[i + 0] = TMP_Q.f67x;
                this.rotationChannel.data[i + 1] = TMP_Q.f68y;
                this.rotationChannel.data[i + 2] = TMP_Q.f69z;
                this.rotationChannel.data[i + 3] = TMP_Q.f66w;
    ...
    public static class BrownianAcceleration extends Strength {
        ...
        public void update() {
            ...
            while (i < c) {
                ...
                fArr[i2] = fArr[i2] + TMP_V3.f107x;
                fArr = this.accelerationChannel.data;
                i2 = forceOffset + 1;
                fArr[i2] = fArr[i2] + TMP_V3.f108y;
                fArr = this.accelerationChannel.data;
                i2 = forceOffset + 2;
                fArr[i2] = fArr[i2] + TMP_V3.f109z;
                i++;
