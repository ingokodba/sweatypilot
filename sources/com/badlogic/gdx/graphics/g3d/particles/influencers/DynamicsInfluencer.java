    ...
    public void update() {
        ...
        if (this.has2dAngularVelocity) {
            ...
            while (i < this.controller.particles.size) {
                ...
                this.rotationChannel.data[offset + 0] = TMP_Q.f67x;
                this.rotationChannel.data[offset + 1] = TMP_Q.f68y;
                this.rotationChannel.data[offset + 2] = TMP_Q.f69z;
                this.rotationChannel.data[offset + 3] = TMP_Q.f66w;
                i++;
                offset += this.rotationChannel.strideSize;
