...
public abstract class RegionInfluencer extends Influencer {
    ...
    public static class AspectTextureRegion {
        ...
        public void set(TextureRegion region) {
            this.f53u = region.getU();
            this.f54v = region.getV();
        ...
        public void set(AspectTextureRegion aspectTextureRegion) {
            this.f53u = aspectTextureRegion.f53u;
            this.f54v = aspectTextureRegion.f54v;
    ...
    public static class Animated extends RegionInfluencer {
        ...
        public void update() {
            ...
            while (i < c) {
                ...
                this.regionChannel.data[i + 0] = region.f53u;
                this.regionChannel.data[i + 1] = region.f54v;
    ...
    public RegionInfluencer() {
        ...
        aspectRegion.f54v = 0.0f;
        aspectRegion.f53u = 0.0f;
