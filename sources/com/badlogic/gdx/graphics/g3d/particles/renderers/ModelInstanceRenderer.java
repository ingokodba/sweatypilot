    ...
    public void update() {
        ...
        while (i < c) {
            ...
            if (this.hasColor) {
                ...
                colorAttribute.color.f39r = ((ModelInstanceControllerRenderData) this.renderData).colorChannel.data[colorOffset + 0];
                colorAttribute.color.f38g = ((ModelInstanceControllerRenderData) this.renderData).colorChannel.data[colorOffset + 1];
                colorAttribute.color.f37b = ((ModelInstanceControllerRenderData) this.renderData).colorChannel.data[colorOffset + 2];
