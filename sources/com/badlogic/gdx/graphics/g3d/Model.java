            ...
            while (it.hasNext()) {
                ...
                if (node != null) {
                    ...
                    if (nanim.translation != null) {
                        ...
                        i$ = nanim.translation.iterator();
                        while (i$.hasNext()) {
                            kf = (ModelNodeKeyframe) i$.next();
                    ...
                    if (nanim.rotation != null) {
                        ...
                        i$ = nanim.rotation.iterator();
                        while (i$.hasNext()) {
                            ModelNodeKeyframe<Quaternion> kf2 = (ModelNodeKeyframe) i$.next();
    ...
    private Material convertMaterial(ModelMaterial mtl, TextureProvider textureProvider) {
        ...
        if (mtl.textures != null) {
            ...
            while (i$.hasNext()) {
                ...
                float offsetU = tex.uvTranslation == null ? 0.0f : tex.uvTranslation.f102x;
                float offsetV = tex.uvTranslation == null ? 0.0f : tex.uvTranslation.f103y;
                float scaleU = tex.uvScaling == null ? 1.0f : tex.uvScaling.f102x;
                float scaleV = tex.uvScaling == null ? 1.0f : tex.uvScaling.f103y;
                switch (tex.usage) {
                    case 2:
