...
public class Sprite extends TextureRegion {
    ...
    public void set(Sprite sprite) {
        ...
        this.u2 = sprite.u2;
        this.v2 = sprite.v2;
        this.f84x = sprite.f84x;
        this.f85y = sprite.f85y;
    ...
    public void setSize(float width, float height) {
        ...
        this.height = height;
        if (!this.dirty) {
            float x2 = this.f84x + width;
            float y2 = this.f85y + height;
            float[] vertices = this.vertices;
            vertices[0] = this.f84x;
            vertices[1] = this.f85y;
            vertices[5] = this.f84x;
            vertices[6] = y2;
            vertices[10] = x2;
            vertices[11] = y2;
            vertices[15] = x2;
            vertices[16] = this.f85y;
            if (this.rotation != 0.0f || this.scaleX != 1.0f || this.scaleY != 1.0f) {
                this.dirty = true;
            }
        }
    ...
    public void setPosition(float x, float y) {
        translate(x - this.f84x, y - this.f85y);
    }

    public void setX(float x) {
        translateX(x - this.f84x);
    }

    public void setY(float y) {
        translateY(y - this.f85y);
    }
    ...
    public float[] getVertices() {
        if (this.dirty) {
            ...
            float worldOriginX = this.f84x - localX;
            float worldOriginY = this.f85y - localY;
    ...
    public Rectangle getBoundingRectangle() {
        ...
        this.bounds.f98x = minx;
        this.bounds.f99y = miny;
    ...
    public Color getColor() {
        ...
        color.f39r = ((float) (intBits & 255)) / 255.0f;
        color.f38g = ((float) ((intBits >>> 8) & 255)) / 255.0f;
        color.f37b = ((float) ((intBits >>> 16) & 255)) / 255.0f;
        color.f36a = ((float) ((intBits >>> 24) & 255)) / 255.0f;
        return color;
    }
