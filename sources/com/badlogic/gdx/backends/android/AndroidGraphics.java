...
public class AndroidGraphics implements Graphics, Renderer {
        ...
        if (checkGL20()) {
            ...
            if (VERSION.SDK_INT > 10 || !this.config.useGLSurfaceView20API18) {
                ...
                if (configChooser != null) {
                    ...
                    view.setEGLConfigChooser(this.config.f33r, this.config.f32g, this.config.f31b, this.config.f30a, this.config.depth, this.config.stencil);
                }
    ...
    protected EGLConfigChooser getEglConfigChooser() {
        return new GdxEglConfigChooser(this.config.f33r, this.config.f32g, this.config.f31b, this.config.f30a, this.config.depth, this.config.stencil, this.config.numSamples);
    }
