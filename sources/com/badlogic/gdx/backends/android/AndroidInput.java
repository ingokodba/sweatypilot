...
public class AndroidInput implements Input, OnKeyListener, OnTouchListener {
        ...
        this.handle.post(new Runnable() {
            ...
            class C00072 implements OnClickListener {
                ...
                public void onClick(DialogInterface dialog, int whichButton) {
                    Gdx.app.postRunnable(new C00061());
                }
            }

            /* renamed from: com.badlogic.gdx.backends.android.AndroidInput$3$3 */
            class C00093 implements OnCancelListener {
                ...
                public void onCancel(DialogInterface arg0) {
                    Gdx.app.postRunnable(new C00081());
                }
            }
            ...
            public void run() {
                ...
                alert.setPositiveButton(AndroidInput.this.context.getString(17039370), new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        Gdx.app.postRunnable(new C00041());
                    }
                });
                alert.setNegativeButton(AndroidInput.this.context.getString(17039360), new C00072());
                alert.setOnCancelListener(new C00093());
                alert.show();
            }
        });
    }
        ...
        synchronized (this) {
            ...
            if (this.processor != null) {
                ...
                for (i = 0; i < len; i++) {
                    ...
                    switch (e.type) {
                        case 0:
                            processor.touchDown(e.f34x, e.f35y, e.pointer, e.button);
                            this.justTouched = true;
                            break;
                        case 1:
                            processor.touchUp(e.f34x, e.f35y, e.pointer, e.button);
                            break;
                        case 2:
                            processor.touchDragged(e.f34x, e.f35y, e.pointer);
                            break;
                        case 3:
                            processor.scrolled(e.scrollAmount);
                            break;
                        case 4:
                            processor.mouseMoved(e.f34x, e.f35y);
                            break;
                        default:
                            break;
                    }
    ...
    private void updateOrientation() {
        if (SensorManager.getRotationMatrix(this.f81R, null, this.accelerometerValues, this.magneticFieldValues)) {
            SensorManager.getOrientation(this.f81R, this.orientation);
