        ...
        public void run() {
            ...
            if (RemoteInput.this.processor != null) {
                if (this.touchEvent != null) {
                    RemoteInput.this.touchX[this.touchEvent.pointer] = this.touchEvent.f55x;
                    RemoteInput.this.touchY[this.touchEvent.pointer] = this.touchEvent.f56y;
                    switch (this.touchEvent.type) {
                        case 0:
                            RemoteInput.this.processor.touchDown(this.touchEvent.f55x, this.touchEvent.f56y, this.touchEvent.pointer, 0);
                            RemoteInput.this.isTouched[this.touchEvent.pointer] = true;
                            RemoteInput.this.justTouched = true;
                            break;
                        case 1:
                            RemoteInput.this.processor.touchUp(this.touchEvent.f55x, this.touchEvent.f56y, this.touchEvent.pointer, 0);
                            RemoteInput.this.isTouched[this.touchEvent.pointer] = false;
                            break;
                        case 2:
                            RemoteInput.this.processor.touchDragged(this.touchEvent.f55x, this.touchEvent.f56y, this.touchEvent.pointer);
                            break;
                    }
                }
                ...
                while (true) {
                    ...
                    switch (in.readInt()) {
                        ...
                        case 3:
                            ...
                            touchEvent.f55x = (int) ((((float) in.readInt()) / this.remoteWidth) * ((float) Gdx.graphics.getWidth()));
                            touchEvent.f56y = (int) ((((float) in.readInt()) / this.remoteHeight) * ((float) Gdx.graphics.getHeight()));
